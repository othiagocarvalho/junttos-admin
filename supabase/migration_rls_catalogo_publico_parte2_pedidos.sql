-- NÃO aplicada em produção — ao contrário das partes 1 e da varredura completa,
-- esta ficou bloqueada no próprio pré-requisito descrito abaixo (ajuste em
-- CatalogoPublico.jsx que nunca foi feito). lf_pedidos acabou protegida por um
-- caminho diferente e já commitado (4122c8e, RLS com janela de 6h para o
-- anon), que resolve o mesmo problema sem quebrar o checkout. Este arquivo é
-- commitado em 18/09/2026 só como registro histórico do rascunho original —
-- ver tag evidencia-stash-rls-18-08-2026. NÃO rode isto contra o banco.
--
