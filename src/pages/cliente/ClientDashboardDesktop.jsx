...
import {
  ...
  User, Phone, CreditCard, ShoppingBag, Lock, Package, Users, Target, Receipt, ArrowLeftRight, Sparkles, Cake, ScanLine,
} from 'lucide-react'
...
const NAV = [
  ...
  { id: 'prevenda',   label: 'Pré-venda',     Icon: ScanLine  },
...
// ── Desktop Pré-venda (bipagem) ─────────────────────────────────
// Mesma arquitetura de PreVenda.jsx (mobile) — ver o comentário completo lá.
...
function DesktopPreVenda({ produtosData = [], addVendaRaw, updateVenda, LOJA_ID = '', theme, config = null, onSalvo }) {
  ...
  return (
    <div style={{ maxWidth: 640, display: 'flex', flexDirection: 'column', gap: 20 }}>
      <div>
        <p style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: 20, fontWeight: 700, color: 'var(--ink)' }}>Pré-venda</p>
        <p style={{ fontFamily: 'Plus Jakarta Sans, sans-serif', fontSize: 13, color: 'var(--muted)', marginTop: 2 }}>
          Bipe as peças separadas — o estoque já baixa na hora.
        </p>
      </div>
